...
<?php
    ...
    // require('process/t-admin-info.php');
?> 
...
<head>
    ...
    <!-- Including style file link / inclusion du fichier style-->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i><strong> Administrez votre site web en toute serenité. </strong>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
