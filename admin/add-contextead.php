<?php
    ...
    require('process/t-forms-contextead.php');
?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Ajout de contexte à une analyse défaillance
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <a href="\admin\index.php"><i class="fa fa-dashboard"></i> Accueil</a> > <small>Ajout de contexte à une analyse défaillance</small>
                            </li>
                        </ol>
                    </div>
                </div>
