<?php
    ...
    require('process/t-forms-expertisedanalyse.php');
?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Ajout d'une expertise d'analyse
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <a href="\admin\index.php"><i class="fa fa-dashboard"></i> Accueil</a> > <small>Ajout d'une expertise d'analyse</small>
                            </li>
                        </ol>
                    </div>
                </div>
