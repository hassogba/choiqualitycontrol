<?php
    ...
    require('process/t-forms-objectifaa.php');
?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Ajout d'objectif à une autre analyse
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <a href="\admin\index.php"><i class="fa fa-dashboard"></i> Accueil</a> > <small>Ajout d'objectif à une autre analyse</small>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <?php include("includes/form-objectifaa.php"); ?>
                    </div>
                    <div class="col-lg-2"></div>
                </div>
            </div>
