<?php
    ...
    require('process/t-forms-objectifad.php');
?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Ajout d'objectif à une analyse défaillance
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <a href="\admin\index.php"><i class="fa fa-dashboard"></i> Accueil</a> > <small>Ajout d'objectif à une analyse défaillance</small>
                            </li>
                        </ol>
                    </div>
                </div>
