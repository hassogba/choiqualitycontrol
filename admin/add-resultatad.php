<?php
    ...
    require('process/t-forms-resultatad.php');
?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Ajout de résultat d'analyse défaillance
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <a href="\admin\index.php"><i class="fa fa-dashboard"></i> Accueil</a> > <small>Ajout de résultat d'analyse défaillance</small>
                            </li>
                        </ol>
                    </div>
                </div>
