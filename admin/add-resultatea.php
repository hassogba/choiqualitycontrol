<?php
    ...
    require('process/t-forms-resultatea.php');
?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Ajout de résultat d'expertise d'analyse
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <a href="\choiqualitycontrol\admin\index.php"><i class="fa fa-dashboard"></i> Accueil</a> > <small>Ajout de résultat d'expertise d'analyse</small>
                            </li>
                        </ol>
                    </div>
                </div>
