<?php
    ...
    require 'process/t-edit-norme.php';
?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Modification d'une norme
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <a href="\choiqualitycontrol\admin\index.php"><i class="fa fa-dashboard"></i> Accueil</a> > <small>Modification d'une norme</small>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <?php include("includes/form-norme.php"); ?>
                    </div>
                    <div class="col-lg-2"></div>
                </div>
            </div>
