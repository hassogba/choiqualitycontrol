<?php 
	...
	$target = '/choiqualitycontrol/admin/edit-autresanalyses.php';
...
<form method="post" enctype="multipart/form-data" action="" data-parsley-validate novalidate="novalidate">
	...
	<div class="form-group">
		<label for="nom">Nom autre analyse <span style="color: red;">*</span> </label>
	...
	<div class="form-group">
		<label for="name">Other analysis name</label>
