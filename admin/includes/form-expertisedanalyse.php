<?php 
	...
	$target = '/choiqualitycontrol/admin/edit-expertisedanalyse.php';
...
<form method="post" enctype="multipart/form-data" action="" data-parsley-validate novalidate="novalidate">
	...
	<div class="form-group">
		<label for="nom">Nom expertise d'analyse <span style="color: red;">*</span> </label>
	...
	<div class="form-group">
		<label for="name">analysis expertise name</label>
