<?php
        ...
        require('process/t-list-contextead.php');
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Liste des contextes des analyses défaillances
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <a href="\choiqualitycontrol\admin\index.php"><i class="fa fa-dashboard"></i> Accueil</a> > <small>Liste des contextes analyses défaillances </small>
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <tbody>
                                <?php while ($prest = $prestations->fetch()) { ?>
                                    <tr>                                         
                                        ...
                                        <td class="text-center">
                                            <span>
                                                <a role="button" title="Modifier le contexte" href="\choiqualitycontrol\admin\edit-contextead.php?nom=<?= $prest['contexte_ligne1'];?>&id=<?= $prest['contexte_id']?>"
                                                   class="edit fa fa-pencil" id="edit-<?= $prest['contexte_id']?>"></a>
                                            </span>

                                            <span>
                                                <?php if ($prest['contexte_active'] == 1) {?>
                                                <a role="button" title="Désactier le contexte" href="\choiqualitycontrol\admin\list-contextead.php?act=disable&nom=<?= $prest['contexte_ligne1'];?>&id=<?= $prest['contexte_id']?>"
                                                   class="del fa fa-fw fa-trash" id="del-<?= $prest['contexte_id']?>"></a>
                                                <?php }else {?>
                                                <a role="button" title="Actier le contexte" href="\choiqualitycontrol\admin\list-contextead.php?act=enable&nom=<?= $prest['contexte_ligne1'];?>&id=<?= $prest['contexte_id']?>"
