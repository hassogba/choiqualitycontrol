<?php
    ...
    require('process/t-list-objectifaa.php');
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Liste des objectifs des autres analyses
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <a href="\choiqualitycontrol\admin\index.php"><i class="fa fa-dashboard"></i> Accueil</a> > <small>Liste des objectifs des autres analyses</small>
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <tbody>
                                <?php while ($prest = $prestations->fetch()) { ?>
                                    <tr>                                       
                                        ...
                                        <td class="text-center">
                                            <span>
                                                <a role="button" title="Modifier la l'objectif" href="\choiqualitycontrol\admin\edit-objectifaa.php?nom=<?= $prest['objectif_ligne1'];?>&id=<?= $prest['objectif_id']?>"
                                                   class="edit fa fa-pencil" id="edit-<?= $prest['objectif_id']?>"></a>
                                            </span>

                                            <span>
                                                <?php if ($prest['objectif_active'] == 1) {?>
                                                <a role="button" title="Désactier l'objectif" href="\choiqualitycontrol\admin\list-objectifaa.php?act=disable&nom=<?= $prest['objectif_ligne1'];?>&id=<?= $prest['objectif_id']?>"
                                                   class="del fa fa-fw fa-trash" id="del-<?= $prest['objectif_id']?>"></a>
                                                <?php }else {?>
                                                <a role="button" title="Actier l'objectif" href="\choiqualitycontrol\admin\list-objectifaa.php?act=enable&nom=<?= $prest['objectif_ligne1'];?>&id=<?= $prest['objectif_id']?>"
