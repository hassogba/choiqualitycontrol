<?php
    ...
    require('process/t-list-resultatea.php');
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <a href="\choiqualitycontrol\admin\index.php"><i class="fa fa-dashboard"></i> Accueil</a> > <small>Liste des résultats des expertises d'analyse</small>
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <tbody>
                                <?php while ($prest = $prestations->fetch()) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span>
                                                <a role="button" title="Modifier le résultat" href="\choiqualitycontrol\admin\edit-resultatea.php?nom=<?= $prest['exemple_idnom'];?>&id=<?= $prest['exemple_id']?>"
                                                   class="edit fa fa-pencil" id="edit-<?= $prest['exemple_id']?>"></a>
                                            </span>

                                            <span>
                                                <?php if ($prest['exemple_active'] == 1) {?>
                                                <a role="button" title="Désactier le résultat" href="\choiqualitycontrol\admin\list-resultatea.php?act=disable&nom=<?= $prest['exemple_idnom'];?>&id=<?= $prest['exemple_id']?>"
                                                   class="del fa fa-fw fa-trash" id="del-<?= $prest['exemple_id']?>"></a>
                                                <?php }else {?>
                                                <a role="button" title="Actier le résultat" href="\choiqualitycontrol\admin\list-resultatea.php?act=enable&nom=<?= $prest['exemple_idnom'];?>&id=<?= $prest['exemple_id']?>"
