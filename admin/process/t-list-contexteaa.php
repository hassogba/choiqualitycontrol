<?php 
    ...
    $prestations = $db->prepare('SELECT * FROM contexte AS p, service AS c WHERE c.service_typeid=3 AND p.contexte_serviceid = c.service_id ORDER BY p.contexte_active DESC');
    $prestations->execute();
