<?php 
    ...
    $prestations = $db->prepare('SELECT * FROM objectif AS p, service AS c WHERE c.service_typeid=3 AND p.objectif_serviceid = c.service_id ORDER BY p.objectif_active DESC');
    $prestations->execute();
 ?>