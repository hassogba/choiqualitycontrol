<?php 
    ...
    $prestations = $db->prepare('SELECT * FROM exemple AS p, service AS c WHERE c.service_typeid=2 AND p.exemple_serviceid = c.service_id ORDER BY p.exemple_active DESC');
    $prestations->execute();
 ?>