            ...
            while ($donnees = $cont->fetch())
              ...
              ?>                     
                                <div class="row">
                                                ...
                                                <div id="contexte1" class="col-lg-12">
                                                    <h3>Contexte</h3>                                 
                                                </div>
                                </div>
                                ...
                                <div class="row">
                                                <div class="col-lg-12">                                 
                                                    <h4 id="contexte1"><?php echo $donnees['contexte_ligne1']; ?></h4> 
                                                </div>
                                </div>
                    ...
                    while ($donnees = $obj->fetch())
                        {
                            ?> 
                                    ...
                                    <div class="row">
                                          <div class="col-lg-offset-1">
                                                <h4 id="objectif"><?php echo $donnees['objectif_ligne2']; ?></h4>
                                           </div>
                                    </div>
                                    <div class="row">
                                         <div class="col-lg-offset-1">
                                                <h4 id="objectif"><?php echo $donnees['objectif_ligne3']; ?></h4>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-offset-1">
                                                <h4 id="objectif"><?php echo $donnees['objectif_ligne4']; ?></h4>
                                        </div>
                                    </div>
